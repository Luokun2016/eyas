		...
		<div class="formbody">
			...
			<cqu:formcols cols="1">
				...
				<input type="text" class="form-control input-sm needVaild"
					name="certification" id="certification" onblur="checkCertificate()" datatype="idcard"
				...
				<input type="text" class="form-control input-sm" name="academic_pos"
					datatype="*" value="${userInfo.academic_pos }" />
				</col>
				<col label="职务" required="required">
				<input type="text" class="form-control input-sm" name="position"
					datatype="*" value="${userInfo.position }" />
				</col>
				<col label="执教中学" required="required">
				...
				<col label="职教课程" required="required">
				<input type="text" class="form-control input-sm needVaild"
					name="teach_course" datatype="*" value="${userInfo.teach_course }" />
				</col>

				<col label="联系电话" required="required">
				<input type="text" class="form-control input-sm" name="mobile" id="mobile" onblur="checkPhone()"
					datatype="m" value="${userInfo.mobile }" />
				</col>
				<col label="电子邮箱" required="required">
				<input type="email" class="form-control input-sm" id="email" onblur="checkEmail()"

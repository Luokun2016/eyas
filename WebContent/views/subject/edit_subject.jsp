...
<body>
	...
	<form action="${base}subject/txEditSubject" method="post"
		class="form-horizontal validate-form">
		<input type="hidden" name="subject_cat_id" value="${subject.subject_cat_id}"/>
		<div class="formbody">
			...
			<cqu:formcols cols="1">			
				...
				<input type="text" name="subject_name" class="form-control input-sm"
					datatype="*"  value="${subject.subject_name}" />
				</col>

				<col label="学科描述" >
				<input	 type="text" name="descript" class="form-control input-sm"
				datatype="*" value="${subject.descript}">		
				</col>			
				<col label="&nbsp;">

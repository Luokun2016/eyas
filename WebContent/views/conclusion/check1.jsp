...
function judge1(str){
	if(str=='unpass')
	{
		var judge=$(document.getElementsByTagName("iframe")[1].contentWindow.document.body).html();
		if(judge==""){
			$.dialog.tips("请给出审核意见！");
			return false;
		}else{
...
<body>
	<div class="place">
		...
		<span>位置：</span>
		<ul class="placeul">
			<li><a href="#">教师结题报告初审</a></li>
		</ul>
	</div>
	<form action="${base}conclusion/check1Conclusion" method="post"

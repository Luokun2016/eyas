...
<body onload="status()">
	<div class="place">
		<div class="pull-right backbtn">
			<a href="${base}conclusion/select">返回上页</a>
		</div>
		<span>位置：</span>
		<ul class="placeul">
			<li><a href="#">教师结题报告查看</a></li>
		</ul>
	</div>
		...
		<div class="formbody">
			...
			<cqu:formcols cols="1">
				...
				<col label="报告描述" full="full">
					<textarea class="simple-editor" name="l_report_des" id="l_report_des" rows="22" cols="105" >${conclusion.conclusion_des}</textarea>
				</col>
				<col label="附件">
				...
				<input type="text" class="form-control input-sm" name="college_date"
					 value="<fmt:formatDate value="${conclusion.college_date}" pattern='yyyy-MM-dd HH:mm'/>"/>
				</col>
				<col label="审核意见" full="full">
					<textarea class="simple-editor" name="remark1" cols="105" rows="15">${conclusion.college_remark}</textarea>
				</col>
				...
				<input type="text" class="form-control input-sm" name="innovation_date"
					 value="<fmt:formatDate value="${conclusion.innovation_date}" pattern='yyyy-MM-dd HH:mm'/>"/>
				</col>
				<col label="创新学院审核意见" full="full">
					<textarea class="simple-editor" name="remark2" cols="105" rows="15">${conclusion.innovation_remark }</textarea>
				</col>
			</cqu:formcols>
		</div>

		...
		<div class="formbody">
			...
			<cqu:formcols cols="1">
				...
				<input type="text" class="form-control input-sm needVaild"
					name="depart" value="${userInfo.depart }" />
				</col>
				...
				<input type="text" class="form-control input-sm needVaild"
					name="degree" value="${userInfo.degree }" />
				</col>
				<col label="职称" required="required">
				<input type="text" class="form-control input-sm needVaild"
					name="academic_pos" value="${userInfo.academic_pos }" />
				</col>
				<col label="职务">
				<input type="text" class="form-control input-sm needVaild"
					name="position" value="${userInfo.position }" />
				</col>
				...
				<input type="text" class="form-control input-sm needVaild"
					name="research_fild" value="${userInfo.research_fild }" />
				</col>

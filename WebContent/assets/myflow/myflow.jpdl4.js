...
$.extend(true,myflow.config.tools.states,{
	start : {
			...
			task : {showType: 'text',type : 'task',
				...
				img : {src : 'img/48/task_empty.png',width :48, height:48},
				props : {
					text: {name:'text', label: '节点名称', value:'', editor: function(){return new myflow.editors.textEditor();}, value:'任务'},
				...
				//	desc: {name:'desc', label : '描述', value:'', editor: function(){return new myflow.editors.inputEditor();}},
				//	post: {name:'post',label:'执行岗位',value:'', editor:function(){return new myflow.editors.postselectEditor('');}},
				//	post: {name:'post',label:'执行岗位',value:'', editor:function(){return new myflow.editors.selectEditor([{name:'aaa',value:1},{name:'bbb',value:2}]);}},
				//	ismsg: {name:'ismsg', label : '是否系统提醒', value:'0', editor: function(){return new myflow.editors.selectEditor(

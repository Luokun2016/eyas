...
(function($) {  
    $.addGt = function(t, p) {   
        ...
        p = $.extend({
            ...
            title: '', 
            exchangeColor: true,
            closeImg: '/jyjt/images/minus.gif',
            openImg: '/jyjt/images/plus.gif',
            lazyLoadImg: '/jyjt/images/plus2.gif',
            blankImg: '/jyjt/images/blank.gif',
            noparentImg: '/jyjt/images/tv-item.gif',
            lastLeafImg: '/jyjt/images/tv-item-last.gif',
            morePageImg: '/jyjt/images/morePage.gif',

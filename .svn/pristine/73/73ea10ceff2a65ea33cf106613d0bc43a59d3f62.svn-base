...
<html>
  ...
  <body>
	...
	<div class="formbody">
		...
		<form action="${base}news/txAddNews" method="post" class="form-horizontal validate-form">
			<input type="hidden" name="flag" value="save"/>
			<cqu:formcols cols="1">
				<col label="类型" required="required">
				...
				<col label="标题" required="required"  >
					<input type="text" class="form-control input-sm" name="title" datatype="*" value="${title }"/>
				</col>
				<col label="内容" full="full">
					<textarea class="editor" name="content" cols="105" style="height:350px;">${content }</textarea>
				</col>
				<col label="附件">
				<div id="file_upload"></div>
				<table class="table table-bordered" id="fj" style="display: none; width: 770px;">
					<tr>
				...
				<col label="访客可见" full="full">
					<select name="view_for_guest" class="form-control input-sm" >
						<option value="1" selected="selected">访客可见</option>
						<option value="0">访客不可见</option>
					</select>
				</col>
				<col label="&nbsp;">

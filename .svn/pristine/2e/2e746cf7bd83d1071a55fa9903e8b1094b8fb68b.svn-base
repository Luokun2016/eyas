...
<body>
	...
	<form action="${base}conclusion/txAddConclusion" method="post" class="form-horizontal validate-form">
		<input type="hidden" class="form-control input-sm" name="batch_id" value="${batch.batch_id }"/>
		<input type="hidden" class="form-control input-sm" name="project_id" value="${record.project_id }"/>
		<div class="formbody">
			<div class="formtitle">
				<span>添加学习报告</span>
			</div>
			<cqu:formcols cols="1">
				<col label="项目名称" >
				<input type="text" class="form-control input-sm" name="" value="${record.project_name}" />
				</col>
				<col label="结题报告模板">
				<a href="${base}conclusion/downLoad2?attach_file=${batch.conclusion_report}" class="btn btn-default btn-sm" id="Downs" >
					<span></span>点击下载</a>	
				</col>
				...
				<col label="报告描述" full="full">
					<textarea class="simple-editor" name="conclusion_des" id="conclusionDes" rows="15" cols="105"></textarea>
				</col>
				<col label="附件">
